...
export default function ProductDetail() {
    ...
    const handleClick = (e) => {
        const product = {id, image, price, option : selected, quantity : 1}
           ...
           <section className='flex flex-col md:flex-row p-4'>
                ...
                <div className='w-full basis-5/12 flex flex-col p-4'>
                    ...
                    <label className='text-brand font-bold' htmlFor='select'>옵션:</label>
                        <select id='select' className='p-2 m-4 flex-1 border-2 border-dashed outline-none' onChange={handleSelect} value={selected}>
